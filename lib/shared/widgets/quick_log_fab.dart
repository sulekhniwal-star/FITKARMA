        ...
        children: [
          ...
          GridView.count(
            ...
            children: const [
              ...
              _QuickLogItem(label: 'Sleep', icon: Icons.bedtime, color: Colors.blueAccent, route: '/sleep'),
              _QuickLogItem(label: 'Glucose', icon: Icons.biotech, color: Colors.orange, route: '/glucose'),
              _QuickLogItem(label: 'Recovery', icon: Icons.bolt, color: Colors.amber, route: '/recovery'),
            ],
          ),
